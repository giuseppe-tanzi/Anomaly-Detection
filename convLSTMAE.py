...
def train(model, batch_size, ctx, num_epochs, path, lr=1e-4, wd=1e-5, params_file="autoencoder_ucsd_convLSTMAE.params"):
    # Dataloader for training dataset
    dataloader = utils.create_dataset(path, batch_size, shuffle=True, augment=True)
